...
<img src="https://raw.githubusercontent.com/social-lorax/new_guides/main/Images/Logos/r_main.png" height="100">

****

#### [Coding with R](r_code.html)
#### [Getting Data into R](r_data.html)
#### [Data Wrangling with R](r_cleaning.html)
#### Visualization with R
#### [Statistics in R](py_stats.html)
#### [Machine Learning in R](py_ml.html)
#### [Text Analysis in R](r_text.html)

#### [Census Data in R](tidycensus.html)

![](https://raw.githubusercontent.com/social-lorax/new_guides/main/Images/Index/underline.gif)

# $\first{Python}$

<img src="https://raw.githubusercontent.com/social-lorax/new_guides/main/Images/Logos/py_main.png" height="100">

****

#### [Coding with Python](py_code.html)
#### [Data Wrangling with Python](py_basic.html)
#### Visualization with Python
#### [Statistics in Python](py_stats.html)
#### [Machine Learning in Python](py_ml.html)

<br>

#### [Principles of Urban Informatics](pui.html)

<br>

[Link to Book](https://bedford-computing.co.uk/learning/wp-content/uploads/2015/10/Python-for-Data-Analysis.pdf)

<img src="https://github.com/social-lorax/new_guides/blob/main/Images/Python/py_data_analysis.jpg?raw=true" width="300">

![](https://raw.githubusercontent.com/social-lorax/new_guides/main/Images/Index/underline.gif)

# $\first{Other Languanges}$
