...
![](https://raw.githubusercontent.com/social-lorax/new_guides/main/Images/Spatial/crs.png)

Common CRSs include: 

* WGS84 (EPSG: 4326) is used when projecting the entire globe or many countries (e.g., Google Earth) 
